...
write_report(rpt, output_type = "PDF")
write_report(rpt, output_type = "DOCX")
write_report(rpt, output_type = "HTML")
write_report(rpt, output_type = "TXT")
